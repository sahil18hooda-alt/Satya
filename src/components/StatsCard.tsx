...
export function StatsCard() {
    return (
        <div className="bg-[#13316c] text-white rounded-none p-8 flex flex-col items-center justify-center text-center shadow-md relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-32 h-32 bg-white/5 rounded-none blur-2xl -translate-x-10 -translate-y-10"></div>
            <div className="absolute bottom-0 right-0 w-40 h-40 bg-white/10 rounded-none blur-3xl translate-x-10 translate-y-10"></div>
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-none backdrop-blur-sm">
                    <div className="flex -space-x-2">
                        {/* Mock avatars */}
                        <div className="w-6 h-6 rounded-none bg-red-400 border-2 border-[#1e3a8a]" />
