    ...
    return (
        <div className="w-full max-w-6xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row items-end justify-between gap-6">
                ...
                {/* Language Selector */}
                <div className="bg-slate-100 p-2 pl-4 rounded-xl flex items-center gap-3 border border-slate-200">
                    ...
                    <select
                        ...
                        className="bg-white border text-sm font-semibold rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-primary shadow-sm"
                    >
                        {LANGUAGES.map(lang => (
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-20 space-y-4 bg-white/50 rounded-3xl border border-dashed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {news.map((item, i) => (
                        <div key={i} className="bg-white border text-card-foreground rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all group flex flex-col h-full">
                            ...
                            <div className="p-5 flex flex-col flex-grow">
                                <div className="flex items-center gap-3 text-xs text-muted-foreground mb-3">
                                    <span className="font-semibold text-orange-600 bg-orange-50 px-2 py-0.5 rounded-full">{item.source}</span>
